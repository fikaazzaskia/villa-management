...
<body>
        ...
        <div class="container position-relative" style="z-index:5;">
            <div class="row align-items-center">
                <div class="col-lg-8" data-aos="fade-right" data-aos-duration="800">
                    <h1 class="hero-title">Selamat Datang, <span style="color: var(--warm-oat);"><?php echo e(session('username')); ?></span></h1>
                ...
                <div class="col-lg-4 text-center" data-aos="fade-left" data-aos-duration="800">
                    <img src="<?php echo e(asset('img/hero-villa.jpeg')); ?>" alt="Villa" style="max-width:220px; border-radius:16px; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.3));">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="glass-panel p-4 mb-4" data-aos="fade-up" data-aos-duration="600">
            <div class="row text-center">
                <div class="col-6 col-md-4 stat-box">
                    <div class="stat-number"><?php echo e($totalBooking); ?></div>
                    <div class="stat-label">Total Booking</div>
                </div>
                <div class="col-6 col-md-4 stat-box">
                    <div class="stat-number"><?php echo e($bookingPending); ?></div>
                ...
                <div class="col-6 col-md-4 stat-box">
                    <div class="stat-number"><?php echo e($totalPembayaran); ?></div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                <a href="/profile" class="dashboard-card">
                    <img src="<?php echo e(asset('img/icon-villa.jpeg')); ?>" class="icon-img" alt="Profil Villa">
                    <h5>Profil Villa</h5>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                <a href="/booking" class="dashboard-card">
                    <img src="<?php echo e(asset('img/icon-booking.jpeg')); ?>" class="icon-img" alt="Booking">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                <a href="/tamu" class="dashboard-card">
                    <img src="<?php echo e(asset('img/icon-tamu.jpeg')); ?>" class="icon-img" alt="Tamu">
                    <h5>Kelola Tamu</h5>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
                <a href="/pembayaran" class="dashboard-card">
                    <img src="<?php echo e(asset('img/icon-payment.jpeg')); ?>" class="icon-img" alt="Pembayaran">
                    <h5>Pembayaran</h5>
    ...
    <footer class="footer-villa">
        <div class="container">
            <p class="mb-0">Villa Management System &copy; <?php echo e(date('Y')); ?> — Semua hak dilindungi.</p>
        </div>
    </footer>
...
</html><?php /**PATH C:\xampp\htdocs\villa-management\resources\views/dashboard.blade.php ENDPATH**/ ?>